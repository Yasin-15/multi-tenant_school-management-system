            ...
            <tbody className="divide-y divide-gray-200">
              {filteredClasses.map((cls) => (
                <tr key={cls._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs rounded-full ${cls.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                      }`}>
              ...
              <div className="flex flex-wrap gap-2">
                {weekDays.map((day) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${formData.schedule.days.includes(day)
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 pb-6 border-b">
              ...
              <div>
                ...
                <span className={`inline-block px-3 py-1 text-xs rounded-full mt-2 ${selectedClass.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                  }`}>
                  ...
                  {selectedClass.teachers && selectedClass.teachers.length > 0 ? (
                    <div className="flex flex-wrap gap-2">
                      {selectedClass.teachers.map((teacher) => (
                        <span key={teacher._id} className="px-3 py-1 bg-purple-100 text-purple-800 text-sm rounded-full">
